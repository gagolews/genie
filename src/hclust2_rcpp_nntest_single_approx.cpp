...
// [[Rcpp::export(".hclust2_nntest_single_approx")]]
RObject hclust2_nntest_single_approx(RObject distance, RObject objects, RObject control=R_NilValue) {
   ...
   try { /* Rcpp::checkUserInterrupt(); may throw an exception */
      ...
      grup::HClustNNbasedNNTestSingleApprox hclust(dist, control);
      // grup::HClustNaiveSingle hclust(dist, control);
      result = hclust.compute();
