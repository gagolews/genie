...
class HClustNNbasedNNTestSingleApprox
{
protected:
   ...
   void getNearestNeighbor(size_t index, NumericMatrix mat);

   List computePrefetch(HclustPriorityQueue& pq);
   void computeMerge(HclustPriorityQueue& pq, HClustResult& res);


public:

   HClustNNbasedNNTestSingleApprox(Distance* dist, RObject control);
   ~HClustNNbasedNNTestSingleApprox();
