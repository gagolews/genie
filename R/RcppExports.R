...
hclust2 <- function(objects, distance = NULL, maxNumberOfElementsInLeaves = 2L) {
    .Call('DataStructures_hclust2', PACKAGE = 'DataStructures', objects, distance, maxNumberOfElementsInLeaves)
}
