...
medoid_exact <- function(distance, objects, control = NULL, limit = TRUE) {
    .Call('DataStructures_medoid_exact', PACKAGE = 'DataStructures', distance, objects, control, limit)
}

medoid_approx <- function(distance, objects, control = NULL, iters = 25L, nntry = 10L) {
    .Call('DataStructures_medoid_approx', PACKAGE = 'DataStructures', distance, objects, control, iters, nntry)
}

seboid_exact <- function(distance, objects, control = NULL, limit = TRUE) {
    .Call('DataStructures_seboid_exact', PACKAGE = 'DataStructures', distance, objects, control, limit)
}

seboid_approx <- function(distance, objects, control = NULL, iters = 25L, nntry = 10L) {
    .Call('DataStructures_seboid_approx', PACKAGE = 'DataStructures', distance, objects, control, iters, nntry)
}
