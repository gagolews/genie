...
# #  <http://danifold.net>
#
# hclust3 <- function(d, method="complete", members=NULL)
# {
...
hclust3 <- function(X, method='single', members=NULL, metric='euclidean', p=NULL)
{
  ...
  dendrogram <- c( .hclust3(methodidx, metric, X, members, p),
    list(
